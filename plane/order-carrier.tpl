...
<form id="form" action="{$link->getPageLink('order.php', true)}" method="post" onsubmit="return acceptCGV();" class="span12">
{else}
<div id="opc_delivery_methods" class="span12 opc-main-block">
