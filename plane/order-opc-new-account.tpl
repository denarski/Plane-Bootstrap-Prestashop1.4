...
<div id="opc_new_account" class="span12 opc-main-block">
	<div id="opc_new_account-overlay" class="opc-overlay" style="display: none;"></div>
	<h2>1. {l s='Account'}</h2>
	<form class="span12" action="{$link->getPageLink('authentication.php', true)}?back=order-opc.php" method="post" id="login_form" class="std">
		<fieldset>
	...
	<form action="#" method="post" id="new_account_form" class="span12 std">
		<fieldset>
